...
export const AuditView = ({ auditTrail }) => {
  ...
  useEffect(() => {
    console.log('[AuditView] API Data (Audit Trail Log):', safeAudit);
  }, [safeAudit]);
      ...
      <div className="card-panel" style={{ padding: 0 }}>
        <div className="table-responsive">
          ...
          <tbody>
            {filtered.length === 0 ? (
              <tr>
                <td colSpan={5} style={{ textAlign: 'center', padding: '30px 10px', color: 'var(--gray)' }}>
                  Tidak ada catatan audit yang tersedia.
                </td>
              </tr>
            ) : (
              filtered.map((item) => (
