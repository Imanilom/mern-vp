  ...
  return (
    <div className="bgg-bl">
      <div className='flex flex-col justify-center items-center min-h-[90vh] relative gap-8'>
        ...
        {/* image jam */}
        <div className="absolute end-0 top-0 md:z-[2] md:w-[40%] lg:w-fit" data-aos="fade-left">
          <img src={jam1} alt="" />
        </div>
        <div className="absolute start-0 lg:end-0 top-0 z-[2] hidden lg:block" data-aos="fade-right">
          <img src={jam2} alt="" />
        </div>
      ...
      <div data-aos="fade-left" className='flex flex-col md:flex-row justify-center items-center py-8 relative gap-8 text-white'>
      ...
      <div data-aos="fade-left" className='flex lg:flex-row flex-col mt-8 justify-between w-9/12 mx-auto items-center py-8 relative gap-8 text-white'>
      ...
      <div data-aos="zoom-in" data-aos-duration="700" className='flex flex-col lg:flex-row mt-8 justify-between w-9/12 mx-auto lg:items-center py-8 relative gap-8 text-white'>
        <div className="lg:w-5/12 relative">
          <div className="rectangle w-screen md:w-96 absolute top-0 start-0 h-16">
        ...
        <div class="overflow-x-auto w-screen p-4">
          <div class="flex space-x-4 justify-center md:justify-start">
            ...
            <div style={{ backgroundImage: `url('${jam3}')` }} class=" hover:shadow-[0px_2px_2px_2px_rgba(255,255,255,0.05)] flex-none group w-28 h-96 bg-cover bg-center rounded-full hover:rounded-[5px] hover:w-[300px] transition-[width,height] duration-500 ease-in-out relative">
              ...
              <div class="absolute inset-0 flex items-end justify-center text-white font-bold opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out ">
      ...
      <div data-aos="fade-left" data-aos-duration="700" className='w-9/12 mx-auto py-8 relative gap-8 text-white'>
