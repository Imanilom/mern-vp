  ...
  return (
    <>
      <div className='flex flex-col gap-8'>
        <section className='text-[#474444] pb-8 pt-16 px-4 font-bold md:w-10/12 lg:w-7/12 lg:mx-24'>
          <h2 className='text-[20px] md:text-[28px] lg:text-[40px] mb-3'>Hey👋, welcome in our project</h2>
          <p className='md:text-[18px] lg:text-[24px]'>
            Are you looking for a way to improve your health and well-being? If so, you might be interested in joining our project<span className='text-[#B76DFD]'> “Activity Tracking”.
            </span>
          </p>
        </section>
        ...
        <section className='' style={{ overflowX: 'auto' }}>
          <div className="flex gap-3 scrool-behavior-animate">
            <img src={project1} className="w-[360px] h-[385px]" alt="Project 1" />
            <img src={project2} className="w-[360px] h-[385px]" alt="Project 2" />
            <img src={project1} className="w-[360px] h-[385px]" alt="Project 1" />
            <img src={project2} className="w-[360px] h-[385px]" alt="Project 2" />
            <img src={project1} className="w-[360px] h-[385px]" alt="Project 1" />
            <img src={project2} className="w-[360px] h-[385px]" alt="Project 2" />
        ...
        <div className="flex items-center px-4 lg:px-0">
          <div className="content lg:mx-24 md:w-10/12 lg:w-7/12 flex flex-col gap-12">
            ...
            <div>
              ...
              <button className='rounded-md mt-4 w-fit text-white font-semibold bg-[#B47AEA] px-6 py-2'>More Information</button>
            </div>
        ...
        <div style={{ overflowX: 'auto' }}>
          <div className="collection-card py-8 flex gap-4 items-center ms-4 lg:mx-24">
            ...
            <card className='max-h-[370px] max-w-[311px] min-w-[311px] border-black px-4 pt-12 pb-4 border rounded-lg flex flex-col gap-2 hover:translate-y-[-20px] duration-500 group'>
              {/* icon */}
            ...
            <card className='max-h-[370px] max-w-[311px] min-w-[311px] border-black px-4 pt-12 pb-4 border rounded-lg flex flex-col gap-2 hover:translate-y-[-20px] duration-500 group'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 32 32"><path fill="black" className='fill-black group-hover:fill-color1' d="M30 12V4h-8v3h-4a2 2 0 0 0-2 2v6h-6v-3H2v8h8v-3h6v6a2 2 0 0 0 2 2h4v3h8v-8h-8v3h-4V9h4v3ZM8 18H4v-4h4Zm16 4h4v4h-4Zm0-16h4v4h-4Z" /></svg>
            ...
            <card className='max-h-[370px] max-w-[311px] min-w-[311px] border-black px-4 pt-12 pb-4 border rounded-lg flex flex-col gap-2 hover:translate-y-[-20px] duration-500 group'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24"><path fill="" className='fill-black group-hover:fill-color1' d="M11 18h2v3h-2zm5 3v2H8v-2zm4-3H4a3.003 3.003 0 0 1-3-3V4a3.003 3.003 0 0 1 3-3h16a3.003 3.003 0 0 1 3 3v11a3.003 3.003 0 0 1-3 3M4 3a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1Z" /><path fill="white" d="m16 15l-1.914-6.38L13 13l-1.309-3h-.331L10 14L8.843 9.933L8.309 11H5v-1h2.691L9 7l1.068 3.713L10.64 9h1.669l.487.973L14 4l2 8l.64-2H19v1h-1.64z" /></svg>
            ...
            <card className='max-h-[370px] max-w-[311px] min-w-[311px] border-black px-4 pt-12 pb-4 border rounded-lg flex flex-col gap-2 hover:translate-y-[-20px] duration-500 group'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 2048 2048"><path fill="" className='fill-black group-hover:fill-color1' d="M2048 896h-896V384H512v256h384v896H512v256h640v-640h896v896h-896v-128H384v-384H0V640h384V256h768V0h896zm-768-768v128h640V128zm0 256v384h640V384zm0 896v128h640v-128zm0 256v384h640v-384zm-512-128v-384H128v384zm0-640H128v128h640z" /></svg>
            ...
            <card className='max-h-[370px] max-w-[311px] min-w-[311px] border-black px-4 pt-12 pb-4 border rounded-lg flex flex-col gap-2 hover:translate-y-[-20px] duration-500 group'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 32 32"><path fill="" className='fill-black group-hover:fill-color1' d="M3.625 25.062a1 1 0 0 1-.77-1.187L6.51 6.585l2.267 9.258l1.923-5.188l3.58 3.74l3.884-13.102l2.934 11.734l1.96-1.51l5.27 11.74a1 1 0 1 1-1.826.817l-4.23-9.428l-2.374 1.826l-1.896-7.596l-2.783 9.393l-3.755-3.924l-3.08 8.314l-1.73-7.083l-1.843 8.71a1 1 0 0 1-1.187.775z" /></svg>
