            ...
            <main>
                <section className="bgg-bl text-white flex">
                    ...
                    <div className="md:w-11/12 py-4 px-16 lg:w-10/12 mb-12 xl:mb-0 mx-auto mt-8 lg:mt-16">
                                    ...
                                    <tbody>
                                        {patients ? patients.map((patient, i) => (
                                            <tr key={patient._id} className={i % 2 == 0 ? 'bg-[#141414]' : 'bg-[#2C2C2C]'}>
                                                ...
                                                <td>
                                                    <button className='darkgreen text-sm px-4 text-start' onClick={() => handleSetPasient(patient._id, patient)}>
                                                        Jadikan Pasien saya
                                                    </button>
                                                </td>
                                            </tr>
                        ...
                        <Link to={'/my-patients'} className='py-3 mb-4 text-center w-full text-white font-semibold rounded-md bgg-dg focus:translate-y-2 duration-150 block'>
                            <button >
