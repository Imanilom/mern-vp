          ...
          {aktivitas?.map((aktivitas) => (
              ...
              <td>
                ...
                <Link to={`/updateActivity/${aktivitas._id}`}>
                  ...
                  <button class="bg-red-700 text-white hover:bg-red-700/80 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Delete</button>
                </div>
              </td>
              </tr>
          ))}
