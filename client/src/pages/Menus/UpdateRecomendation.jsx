...
function UpdateRecomendation() {
    ...
    return (
        <main class="bgg-bl text-white flex pb-8">
            <Side />
            <div class="flex min-h-[90vh] justify-start m-16">
                <div class="mx-auto w-10/12 lg:w-full max-w-lg">
                    <h1 class="text-2xl lg:text-4xl font-semibold">Update The Activity</h1>
                    ...
                    <form onSubmit={handleSubmit} method='post' class="mt-6">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Link to='/rekomendasi' class="mt-5 rounded-md px-5 py-2 text-white hover:text-[#007CC6]">Cancel</Link>
                        </div>
                    </form>
                </div>
            </div>
