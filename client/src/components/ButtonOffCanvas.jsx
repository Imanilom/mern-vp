...
function ButtonOffCanvas() {
    ...
    return (
        <>
            <div class="w-full mb-3 inline lg:hidden">
            ...
            {isView ? (
                <div class="fixed py-[15vh] min-h-screen top-0 left-0 z-40 h-screen overflow-y-auto transition-transform bg-[#101010] w-80" >
                    {/* <h5 id="drawer-label" class="ms-4 inline-flex items-center mb-4 text-base font-semibold text-gray-800 "><svg class="w-4 h-4 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                    </svg>Dashboard Menu</h5>
                    <button onClick={() => setView(!isView)} type="button" data-drawer-hide="drawer-example" aria-controls="drawer-example" class="text-gray-400 bg-transparent hover:bg-gray-200 rounded-lg mt-4 text-sm w-8 h-8 absolute top-2.5 end-2.5 flex items-center justify-center " >
                    ...
                    */}
                    ...
                    {/* menu drawer same */}
                    <div className="relative items-between flex-col rounded-xl text-gray-700 h-[calc(100vh-2rem)] w-full max-w-[20rem] ">
                        <Sidebar className='border-none border-transparent'>
                            <Menu className='bg-[#101010] shadow-none border-none outline-none text-white/90'>

                                {currentUser.role != 'user' && DocterPatient == null ? (
                                    //show only for admin
                                    <Link to='/my-patients'>
                                        <div>
                                            <div role="button" tabindex="0" class="flex py-3 px-8 items-center w-full text-start leading-tight transition-all hover:bg-[#005A8F] text-sm outline-none">
