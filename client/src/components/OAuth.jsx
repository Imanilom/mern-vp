...
export default function OAuth() {
  ...
  return (
    ...
    <button onClick={handleGoogleClick} type="button" class="flex items-center gap-1 text-white bgg-bl hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-2">
