...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (success) {
      // Simpan email & timestamp pertama kali login (untuk hitung hari partisipasi)
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('user_email', email);
      if (!prefs.containsKey('first_login_ms')) {
        await prefs.setInt('first_login_ms', DateTime.now().millisecondsSinceEpoch);
      }
      if (!mounted) return;
